...
ENTRIES = [
    {
        "name": 'Administration',
        "slots": 1, "ability": 'Intelligence', "modifier": 1,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'Player characters with artistic ability are naturally accomplished in various forms of the arts. They have an inherent understanding of color, form, space, flow, tone, pitch, and rhythm. Characters with artistic ability must select one art form (painting, sculpture, composition, etc.) to be proficient in. Thereafter they can attempt to create artworks or musical compositions in their given field. Although it is not necessary to make a proficiency check, one can be made to determine the quality of the work. If a 20 is rolled on the check, the artist has created a work with some truly lasting value. If the check fails, the artist has created something aesthetically displeasing or just plain bad.\n\nArtistic ability also confers a +1 bonus to all proficiency checks requiring artistic skill--music or dance--and to attempts to appraise objects of art.',
    },
    {
        "name": 'Baking',
        "slots": 1, "ability": 'Intelligence', "modifier": 0,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A character with this skill can bake breads, pies, cakes, cookies, and all sorts of baked goods. No check need be made unless something of exceptional skill is being attempted, or a large quantity is to be done in a tight time frame.',
    },
    {
        "name": 'Blacksmithing',
        "slots": 1, "ability": 'Strength', "modifier": 0,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A character with blacksmithing proficiency is capable of making tools and implements from the basic metals: Iron, copper, lead, tin, zinc, brass, bronze, etc.. Use of the proficiency requires a forge with a coal-fed fire and bellows, as well as a hammer and anvil. The character cannot make armor or most weapons, but can craft crowbars, grappling hooks, horseshoes, nails, hinges, plows, and most other metal objects.',
    },
    {
        "name": 'Boating',
        "slots": 1, "ability": 'Intelligence', "modifier": 0,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'Although all characters have rudimentary cooking skills, the character with this proficiency is an accomplished cook. A proficiency check is required only when attempting to prepare a truly magnificent meal worthy of a master chef.',
    },
    {
        "name": 'Dancing',
        "slots": 1, "ability": 'Dexterity', "modifier": 0,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character has a knowledge of the basics of farming. This includes planting, harvesting, storing crops, tending animals, butchering, and other typical farming chores.',
    },
    {
        "name": 'Fire-building',
        "slots": 1, "ability": 'Wisdom', "modifier": -1,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'This proficiency gives a character a knowledge of various myths and legends of monstrous or wondrous creatures. Someone with folklore would be aware that silver weapons are needed to cause real harm to werewolves, or that vampires might have trouble crossing running water. Folklore is generally somewhat unreliable so the DM should make the check in secret every time a character wishes to use this proficiency. On a failure, the DM should give out some incorrect information as well.',
    },
    {
        "name": 'Gaming',
        "slots": 1, "ability": 'Charisma', "modifier": 0,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A proficient jeweler can make, with the right tools, various sorts and types of jewelry. Repairs and embellishments can be made to existing pieces as well. Knowing how to make jewelry and knowing what its worth are two different things.',
    },
    {
        "name": 'Jumping',
        "slots": 1, "ability": 'Strength', "modifier": 0,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character can speak one additional living language of his choice, declared when the slot is filled. (Reading and writing that language additionally requires the Literacy proficiency.)',
    },
    {
        "name": 'Leatherworking',
        "slots": 1, "ability": 'Intelligence', "modifier": 0,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'This proficiency enables a character to tan and treat leather and to make clothing and other leather objects. The character can make leather armor, as well as backpacks, saddlebags, saddles, and all sorts of harnesses.',
    },
    {
        "name": 'Lumberjacking',
        "slots": 1, "ability": 'Strength', "modifier": 3,
        "classes": ('Warrior',),
        "prereq": (),
        "description": 'A character with the Lumberjacking proficiency is adept at felling and stripping trees. He can direct which way a tree will fall, identify which trees might be too warped to provide good wood for construction, and is knowledgeable about tree diseases and pests. If a tree needs to be felled in an exact direction, say to fall between two buildings without striking them, or to land just so as part of a trap, a proficiency check must be made.',
    },
    {
        "name": 'Mining',
        "slots": 2, "ability": 'Intelligence', "modifier": -3,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": ('Seamanship',),
        "description": 'The character has learned the arts of navigating by the stars, studying currents, and watching for telltale signs of land, reefs, and hidden danger. This is not particularly useful on land. At sea, a successful proficiency check by the navigator reduces the chance of getting lost by 20 percent.',
    },
    {
        "name": 'Pottery',
        "slots": 1, "ability": 'Dexterity', "modifier": -2,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character is familiar with boats and ships. He is qualified to work as a crewman, although he cannot actually navigate. Crews of trained seamen are necessary to manage any ship, and they improve the movement rates of inland boats by 50 percent.',
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character can sew and design clothing. He can also do all kinds of embroidery and ornamental work. Although no proficiency check is required, the character must have at least needle and thread to work.',
    },
    {
        "name": 'Set Snares',
        "slots": 1, "ability": 'Wisdom', "modifier": -1,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": ('Carpentry',),
        "description": 'A character with the Shipwright proficiency can oversee the construction of basic ships. For larger vessels the character must also have an engineering proficiency or be working with someone who has one.',
    },
    {
        "name": 'Singing',
        "slots": 1, "ability": 'Charisma', "modifier": 0,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character is an accomplished singer and can use this ability to entertain others and perhaps earn a small living (note that bards can do this automatically). No proficiency check is required to sing. The character can also create choral works on a successful proficiency check.',
    },
    {
        "name": 'Stonemasonry',
        "slots": 1, "ability": 'Strength', "modifier": -2,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A stonemason is able to build structures from stone so that they last many years. He can do simple stone carvings, such as lettering, columns, and flourishes. The stone can be mortared, carefully fitted without mortar, or loosely fitted and chinked with rocks and earth. A stonemason equipped with his tools (hammers, chisels, wedges, block and tackle) can build a plain section of wall one foot thick, ten feet long, and five feet high in one day, provided the stone has already been cut. A stonemason can also supervise the work of unskilled laborers to quarry stone; one stonemason is needed for every five laborers. Dwarves are among the most accomplished stonemasons in the world; they receive a +2 bonus when using this skill.',
    },
    {
        "name": 'Story Telling',
        "slots": 1, "ability": 'Charisma', "modifier": 0,
        ...
        "prereq": (),
        "description": 'The character is a practiced teller of tales, able to entertain an audience with myths, legends, and yarns. On a successful proficiency check he adds a story to his repertoire or holds a crowd; a well-told tale can grant a temporary Charisma bonus with a receptive audience.',
    },
    {
        "name": 'Survival',
        "slots": 2, "ability": 'Wisdom', "modifier": 0,
        "classes": ('Warrior',),
        "prereq": (),
        "description": 'This proficiency must be applied to a specific environment--i.e., a specific type of terrain and weather factors. Typical environments include: arctic, woodland, desert, plains, or tropical. Mountains are not usually a separate terrain type, a mountain range may be tropical, wooded, snow-covered, etc.. The character has basic survival knowledge for that terrain type. Additional proficiency slots can be used to add more types of terrain.\n\nA character skilled in survival has a basic knowledge of the hazards he might face in that land. He understands the effects of the weather and knows the proper steps to lessen the risk of exposure. He knows the methods to locate or gather drinkable water. He knows how to find basic, not necessarily appetizing, food where none is apparent, thus staving off starvation. The character can roll a proficiency check once a day for each category. Success means food, water, or shelter is found. Typically it will take 1d6 hours to find water, and 2d6 turns to forage enough food for one person. If one is going to be foraging a lot in one day and wishes to simplify, the following optional system may be used.\n\nA forager may spend 2 hours searching for food to find 1d2 standard days of food. This requires a single proficiency check. Overland travel while foraging can be accomplished by reducing movement speed to ¼ during the time foraging.\n\nA character with this skill also understands the perils inherent in sudden storms and dangerous topical features: avalanches, quicksand, sandstorms, and landslides, for example. The DM might allow a player to roll a proficiency check when one of these dangers appears on the horizon, success means the character has noticed the menace.\n\nThe survival skill in no way releases the player characters from the hardships and horrors of being lost in the wilderness. At best it alleviates a small portion of the suffering. The food found is barely adequate, and water is discovered in minuscule amounts. It is still quite possible for a character with survival knowledge to die in the wilderness. Indeed, the little knowledge the character has may lead to overconfidence and doom!',
    },
    {
        "name": 'Swimming',
        "slots": 1, "ability": 'Strength', "modifier": 0,
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A character with swimming proficiency knows how to swim. Those without this proficiency cannot swim. They can hold their breath and float, but they cannot move themselves about in the water.',
    },
    {
        "name": 'Torturing',
        "slots": 1, "ability": 'Wisdom', "modifier": 0,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Priest'),
        "prereq": (),
        "description": 'Instructing someone in skills is a difficult task, but someone with this proficiency is able to instruct others in a skill or language that the tutor knows. Your DM will tell you how this works out.',
    },
    {
        "name": 'Weaponsmithing',
        "slots": 2, "ability": 'Intelligence', "modifier": -3,
    ...
    },
    {
        ...
        "classes": ('Warrior', 'Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'A character with weaving proficiency is able to create garments, tapestries, and draperies from wool or cotton. The character requires a spinning apparatus and a loom. A weaver can create two square yards of material per day.',
    },
    {
        "name": 'Acting',
        "slots": 1, "ability": 'Charisma', "modifier": -1,
        "classes": ('Rogue',),
        "prereq": (),
        "description": 'Acting enables a character to skillfully portray various roles. Acting is most often used as a form of entertainment; it can also be useful in aiding a disguise. If both acting and disguise are known, the proficiency check for either is made with a +1 bonus.\n\nProficiency checks are required only if the actor must portray a particularly difficult character or is attempting an "ad lib" role (i.e., a non-rehearsed role or on short notice).',
    },
    {
        "name": 'Alchemy',
        "slots": 2, "ability": 'Intelligence', "modifier": -3,
        "classes": ('Wizard',),
        "prereq": (),
        "description": 'A character with the Alchemy proficiency can make any of the alchemical items in the alchemy document, given the proper tools and supplies. Making a stimulant like Gnome Dust requires access to the correct plants, but an alchemist knows how to process and distill the plant into its final form. The price to make something from the table is 75% of its sale value, although if large batches are being made, this can be brought down to 66% or even 50% with a great scale of industry.',
    },
    {
        "name": 'Anatomy',
        "slots": 1, "ability": 'Intelligence', "modifier": -2,
        "classes": ('Rogue', 'Wizard', 'Priest'),
        "prereq": (),
        "description": 'This proficiency reflects a character’s detailed knowledge of the structure and arrangement of the human body, including the location and function of bones, muscles, organs, and other soft tissues. \n\nA spell caster can use this skill to repair corpses that have been badly damaged. With a successful proficiency check, the caster can strengthen and reinforce a body, making it more suitable for animation as a mindless undead. This provides a hit point bonus of +1 per die for skeletal remains, or a bonus of +2 hp per die for a creature to be animated as a zombie.',
    },
    {
        "name": 'Appraising',
        "slots": 1, "ability": 'Intelligence', "modifier": 0,
        "classes": ('Rogue',),
        "prereq": (),
        "description": 'This proficiency is highly useful for thieves, as it allows characters to estimate the value and authenticity of antiques, art objects, jewelry, cut gemstones, or other crafted items they find (although the DM can exclude those items too exotic or rare to be well known). The character must have the item in hand to examine. A successful proficiency check (rolled by the DM) enables the character to estimate the value of the item to the nearest 100 or 1,000 gp and to identify fakes. On a failed check, the character cannot estimate a price at all. On a roll of 1, the character wildly misreads the value of the item, always to the detriment of the character.',
    },
    {
        "name": 'Arcanology',
        "slots": 1, "ability": 'Intelligence', "modifier": -3,
        "classes": ('Wizard',),
        "prereq": (),
        "description": 'The study of the history and development of magic is termed arcanology. A character with expertise in this field is familiar with the works of past wizards. If there was a source of powerful magic in the campaign’s past—for example, Netheril or Myth Drannor in the Forgotten Realms campaign setting—the arcanologist has a good idea of who the great mages were and what they were able to accomplish. Special magical items, spells, or forms of magic wielded by these ancient sorcerers are familiar to the arcanologist. With a successful proficiency check, the arcanologist can identify the general purpose and function of an ancient magical item; the DM may apply a penalty of –1 to –4 if the item comes from a region outside the arcanologist’s normal studies, or is especially rare or obscure. Note that this ability doesn’t help a character to identify items manufactured by the “modern” school or tradition of magic, whatever that may be.',
    },
    {
        "name": 'Bookbinding',
        "slots": 1, "ability": 'Intelligence', "modifier": 3,
    ...
    },
    {
        ...
        "classes": ('Wizard', 'Priest'),
        "prereq": (),
        "description": 'A character with this proficiency is skilled at calligraphy. If they wish to produce an especially fancy work, a check might be called for.',
    },
    {
        "name": 'Cartography',
        "slots": 1, "ability": 'Intelligence', "modifier": 0,
        "classes": ('Rogue', 'Wizard', 'Priest'),
        "prereq": ('Literacy',),
        "description": 'This proficiency grants skill at map making. A character can draw maps to scale, complete with complex land formations, coastal outlines, and other geographic features. The character must be reasonably familiar with the area being mapped.\n\nThe DM makes a proficiency check in secret to determine the accuracy of the map. A successful proficiency check means that the map is correct in all significant details. If the roll fails, the map contains a few errors, possibly a significant one. A roll of exactly 1 means the map contains serious errors, making it useless.',
    },
    {
        "name": 'Embalming',
        "slots": 1, "ability": 'Intelligence', "modifier": 2,
        "classes": ('Priest',),
        "prereq": ('Anatomy',),
        "description": 'This skill covers the techniques of preserving the dead. No check need be made unless the character wishes to preserve the body above and beyond the normal lengths of time.',
    },
    {
        "name": 'Engineering',
        "slots": 1, "ability": 'Intelligence', "modifier": -3,
    ...
    {
        "name": 'Healing',
        "slots": 1, "ability": 'Wisdom', "modifier": -2,
        "classes": ('Priest',),
        "prereq": ('Anatomy',),
    ...
    {
        "name": 'Herbalism',
        "slots": 2, "ability": 'Intelligence', "modifier": -2,
        "classes": ('Wizard', 'Priest'),
        "prereq": (),
        "description": 'Those with herbalist knowledge can identify plants and fungus and prepare nonmagical potions, poultices, powders, balms, salves, ointments, infusions, and plasters for medical and pseudo-medical purposes. They can also prepare natural plant poisons and purgatives. The DM must decide the exact strength of such poisons based on the poison rules in the DMG. A character with both herbalism and healing proficiencies gains bonuses when using his healing talent (see the Healing proficiency).',
    },
    {
    ...
    },
    {
        ...
        "classes": ('Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character has mastered a difficult and obscure tongue, now primarily found in the writings of pedantic sages and sorcerers. The main use of the language is to read tomes of ancient secrets written by long-dead mystics. This proficiency enables the character to either read and write or speak the language (his choice).',
    },
    {
        "name": 'Literacy',
        "slots": 1, "ability": '', "modifier": 0,
        "classes": ('Wizard', 'Priest'),
        "prereq": (),
        "description": 'The character can read and write any modern language he is able to speak, provided someone is available to teach him the script.',
    },
    {
        "name": 'Mathematics',
        "slots": 1, "ability": 'Intelligence', "modifier": -3,
        "classes": ('Wizard', 'Priest'),
        "prereq": (),
        "description": 'Having this proficiency makes a character familiar with all types of mathematics upto and including algebra, geometry, trigonometry, and statistics.',
    },
    {
        "name": 'Omen Reading',
        "slots": 2, "ability": 'Wisdom', "modifier": -2,
